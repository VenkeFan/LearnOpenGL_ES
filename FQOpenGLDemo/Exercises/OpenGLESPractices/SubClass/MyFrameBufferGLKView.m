...
@interface MyFrameBufferGLKView () <GLKViewDelegate>
...
@implementation MyFrameBufferGLKView
...
- (void)renderView {
    ...
    modelViewMatrix = GLKMatrix4Rotate(modelViewMatrix, 30.f, 1.0, 1.0, 0.0);
    ...
    height = self.bounds.size.height * self.contentScaleFactor;
