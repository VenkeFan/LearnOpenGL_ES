...
//    vec3 ambient = vec3(material.ambient.r * lightColor.r, material.ambient.g * lightColor.g, material.ambient.b * lightColor.b);
    ...
    vec3 specular = (spec * material.specular) * lightColor * light.specular;
